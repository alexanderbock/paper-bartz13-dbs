...
Presenting the uncertainties about the potential target regions is one of the key features of our system. The \emph{Electrode Closeup} enables the surgeon to qualitatively inspect possible target regions embedded in the spatial context. In contrast, the \emph{Uncertainty View} presents the quantitative aspect of the recorded data and enables the data-driven decision making.

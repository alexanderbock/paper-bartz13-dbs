...
\noindent \textbf{Uncertainty View} Each data source provides information about the actual location of the target region, along with an uncertainty. In this view, shown in Figure~\ref{fig:placementguide}, these probabilities and uncertainties are presented to the surgeon.
